package com.JackClasses.DMS.Controllers;
/**
 * @author Anthony Jack
 */
...
import com.JackClasses.DMS.Models.Trainer;
import com.JackClasses.DMS.repository.DogRepository;
import com.JackClasses.DMS.repository.TrainerRepository;
...
//		Optional<Dog> deletedDog = dogRepo.findById(dog.getId());
